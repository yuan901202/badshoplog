<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NumberOneShoesPage.aspx.cs" Inherits="NumberOneShoesPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:TextBox ID="NumberOneShoesTextBox" runat="server" Height="300px" Width="800px" CssClass="content"></asp:TextBox>
    <br />
    <br />
